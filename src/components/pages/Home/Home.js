...
function Home({ media }) {
  ...
  return (
    <>
      ...
      <Grid
        className="container container-head container-home"
        sx={{ background: 'none' }}
      >
        <Container>
          <Grid container>
            <Grid container>
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: '600' }}>
                  Slashbin.xyz is a decentralized autonomous guild of
                  freelancers and OGs developers.
                </Typography>

                {!media.md && (
                  <Typography variant="h4" sx={{ fontWeight: '600' }}>
                    We build your project from A to Z for Bitcoin and Crypto
                    projects.
                  </Typography>
                )}
              </Grid>
